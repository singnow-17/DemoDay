...
import {FormCadBanda} from '../Formularios/FormCadBanda';
...
export function CadastroBanda(){
    ...
    const [numeroIntegrantes, setNumeroIntegrantes] = React.useState('');
    const [emailBanda, setEmailBanda] = React.useState('');
    ...
    const getCompSetp = () =>{
        switch(etapa){
            case 0:
                return <FormCadBanda 
                nomeBanda={nomeBanda} setNomeBanda={setNomeBanda}
                numeroIntegrantes={numeroIntegrantes} setNumeroIntegrantes={setNumeroIntegrantes}
                emailBanda={emailBanda} setEmailBanda={setEmailBanda}
    ...
    return(
        <div className='container-cad'>
            <div className='conteudo-cad'>
                <Card sx={{ display: 'flex', maxWidth: 800, height: 500, borderRadius:5, boxShadow:5}}>
                    <Box sx={{ display: 'flex', flexDirection: 'column', bgcolor: '#FA9201', p:2, minWidth:144, width:'15vw', height:500, overflow:'hidden'}}>
                    ...
                    <Box className='form' sx={{ alignItems: 'center', p:1, marginTop:2, width:'30vw', height:434}}>
                        ...
                        {getCompSetp()}
                        <Alert severity="error" ref={mensagemErro} className="msgErro hide"><span className="msgText" ref={mensagemTexto}>test</span></Alert>
